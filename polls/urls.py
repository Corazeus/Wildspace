...
urlpatterns = [
    ...
    path('wiluser/area_button_click/', views.area_button_click, name='areaButtonClick'),
    ...
    path('wiluser/insert-into-database/', insert_into_database, name='insertIntoDatabase'),
    path('wiluser/show_message/', show_message_view, name='show_message'),
    ...
    path('wiluser/get_timer_data/', views.get_timer_data, name='get_timer_data'),
    path('wiluser/end_session/', views.end_session_view, name='end_session'),
    path('wiluser/get-booking-info/', views.get_booking_info, name='get_booking_info'),
    path('wiluser/get-reservebooking-info/', views.get_reservebooking_info, name='get_reservebooking_info'),
    path('wiluser/get-calendar-data/', views.get_calendar_data, name='get_calendar_data'),
